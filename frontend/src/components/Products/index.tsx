...
import { Box, Button, Checkbox, Divider, FormControlLabel, FormGroup, Stack, TextField } from "@mui/material";
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <FormGroup>
                        <FormControlLabel 
                            control={<Checkbox checked={product?.manual_price ?? false}/>} 
                            label="Manual Price" 
                            sx={{color: "black"}}
                            />
                    </FormGroup>
                        ...
                        <TextField
                            ...
                            inputProps: {
                                ...
                                onValueChange: async (value: string) => {
                                    ...
                                    tempPrices[index] = {...tempPrices[index], price: value}
                                setProduct({
                                    ...product,
                                    prices: tempPrices,
                                });
