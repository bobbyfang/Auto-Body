...
import { Modal, Box, Button, TableContainer, Paper, TableCell, TableRow } from "@mui/material";
...
export default function ProductsModal({open, setOpen, setAlertMessage, setAlertVisibility, setSeverity, setProduct}: Props) {
